...
#define ADV_INTERVAL_IN_MS              3200
...
//    APP_ERROR_CHECK(err_code);
    ...
    // Register with the SoftDevice handler module for BLE events.
    //err_code = softdevice_sys_evt_handler_set(ble_evt_dispatch);
    //APP_ERROR_CHECK(err_code);
}
...
static void advdata_update(void)
{
    ...
    uint32_t temperature_data = ++temperature;
//    
